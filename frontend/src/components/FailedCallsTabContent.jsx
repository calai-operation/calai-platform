  ...
  return (
    <div className="bg-[#161616] border border-[#262626] rounded-xl overflow-hidden mb-8">
      ...
      <div className="p-6 pb-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-[#262626]">
        <div>
          <h2 className="text-[18px] font-semibold text-white mb-1">Failed calls</h2>
          <p className="text-[12px] text-gray-500">
            Provider failures and missed calls - additional failed Twilio legs are identified separately
          </p>
        </div>
...
export default FailedCallsTabContent;
